...
private $index = 
  [
    ...
    [
      ...
      'image' => 'https://covers.openlibrary.org/b/olid/OL16980586M-M.jpg',
       ...
       'short_desc' => "It's been nearly 25 years since Robert Kiyosak's Rich Dad Poor Dad first made waves in the Personal Finance arena. It has since become the #1 Personal Finance book of all time... translated into dozens of languages and sold around the world."
    ],
    [
      'id' => 5, 
  ...
  public function indexs(Request $request)
  {
     if($request->has('search')){
      ...
      $books= Book::where('id','LIKE',"%$keyword%")
      ...
      $books = Book::paginate(5);//harus ada if else .. tadi 
     }
    ...
    $book = new Book(); //!! ada yg eror di eloquent ini
    return $book->all(); 
    */
  }
  ...
  {
     return view('createbooks'); //'createBooks itu nama file edit nya supaya ke return di file sana fungsi method di controller.
  }
  ...
  public function store(BookPostRequest $request )
  {
    ...
    return redirect()
    ->route('book.index')
    ->with('status','Data saved Succesfullu');//lanjutin flash massage valiation
  ...
  {
    $books = Book::find($id);
     return view('detail', ["index" => $books]); //
  }
  ...
  public function edit(string $id)
  {
    ...
    return view('editbook', ["index" => $books]);
